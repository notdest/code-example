...
class storiesByOne implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        foreach ($sources as $source) {
            $url        = "https://instagram85.p.rapidapi.com/account/{$source->userId}/stories";
            ...
            $stories    = $data->data[0];
            $ids        = array_map(function ($v){return $v->id;},$stories);

            DB::table('stories')->whereIn('storyId', $ids)->update(['sourceId' => $source->id]);
